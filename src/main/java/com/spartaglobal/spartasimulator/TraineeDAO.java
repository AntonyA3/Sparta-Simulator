    ...
    public ArrayList<Client> getClients() {
        ...
        try{
            ...
            while (rs.next()){
                ...
                Integer reqQuantity = (rs.getObject("client_req_start_quantity") != null) ?
                        rs.getInt("client_req_start_quantity") : null;
...
//        try{
//            PreparedStatement preparedStatement = connection.prepareStatement(sql);
//            preparedStatement.setString(1, c.getReqType());
//            preparedStatement.setInt(c.getClientID());
//            preparedStatement.executeUpdate();
////            while (rs.next()){
////                int id = rs.getInt("client_id");
////                String state = rs.getString("client_state");
